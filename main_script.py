...
def callback():
    ...
    # the query to search for, include bad words inside of the parentheses
    data = '{"query": "() from:' + screen_name + '", "maxResults": "301", "fromDate": "200603220000"}' # WORKING QUERY (TESTING MULTIPLE TERMS IN ONE REQUEST)
